...
const ColumnContainer = (props: Props) => {
  ...
  const {
    ...
    const { isLoading, executeTasks } = useTaskExecutor();
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="stroke-gray-500 hover:stroke-white p-1.5 hover:bg-columnBackgroundColor rounded disabled:opacity-30 disabled:cursor-not-allowed"
          >
            <PlayIcon />
          </button>
          <button
